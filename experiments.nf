...
workflow {
  ...
  funs_ch = Channel.of('median')//'mean', 'median')
  cors_ch = Channel.of(0.7)//, 0.8, 0.9)
  gams_ch = Channel.of(4.0)//1.0, 2.0, 4.0)
  seeds_ch= Channel.of(797)//3990, 5057, 8585, 7265, 4468, 9334, 3641, 6101, 2721, 4855, 4787, 4022, 4477, 4202, 6729, 4235, 4428, 6422, 1555, 797, 2320, 3804, 8006, 6459, 2701, 3462, 3121, 6927, 4582, 5351)
